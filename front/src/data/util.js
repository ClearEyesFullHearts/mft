...
class Messaging {
  ...
  static getResponseErrorMessage(error) {
...
export class ResponseWrapper {
  constructor(response, data = {}, message) {
    ...
    this.statusMessage = Messaging.getStatusMessage(this.status);
...
export class ErrorWrapper extends Error {
  constructor(error, message) {
    ...
    this.statusMessage = Messaging.getStatusMessage(this.status);
    this.message = message || Messaging.getResponseErrorMessage(error);
  }
}
